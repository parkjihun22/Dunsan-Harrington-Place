...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
				...
				<meta
					name="description"
					content="둔산 해링턴 플레이스 분양 계약을 위한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 빠르고 정확하게 확인하세요."
				/>
				...
				{/* SEO 최적화용 h1 */}
				<h1 className={styles.screenReaderOnly}>둔산 해링턴 플레이스 - 계약서류안내</h1>
				<p className={styles.screenReaderOnly}>
				둔산 해링턴 플레이스 계약서류안내 페이지에서는 분양 당첨 후 필요한
				서류들을 안내합니다. 계약 체결을 위해 준비해야 할 신분증, 주민등록등본,
				인감증명서 등 필수 서류와 제출 절차, 유의사항을 확인하실 수 있습니다.
				</p>

				<div className={styles.textBox}>
				<div>계약 준비를 위한 정확한 가이드</div>
				<div>둔산 해링턴 플레이스 계약서류안내</div>
				</div>


			{/* 이미지에 isImageVisible 상태 적용 */}
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="둔산 해링턴 플레이스 계약서류안내-image1" /> */}
