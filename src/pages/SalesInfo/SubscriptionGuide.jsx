...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        <Helmet>
          <title>둔산 해링턴 플레이스 - 청약방법 안내</title>
          <meta
            name="description"
            content="둔산 해링턴 플레이스 청약방법을 확인하세요. 청약 자격, 신청 절차, 준비 서류 및 유의사항을 상세히 안내합니다."
          />
      ...
      <p className={styles.screenReaderOnly}>
        둔산 해링턴 플레이스 분양 전 필수 체크포인트를 확인하세요. 청약
      ...
      <div className={styles.textBox}>
        <div>둔산 해링턴 플레이스가 눈부신 가치 위에</div>
      ...
      {/* <img
        ...
        src={page1}
        alt="둔산 해링턴 플레이스 청약제도 변경안내 이미지1"
