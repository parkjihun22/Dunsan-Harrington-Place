...
import page1 from "../../assets/FloorPlan/FloorPlan6/unit01_img06.jpg"
...
const FloorPlan6 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<Bener title="둔산 해링턴 플레이스 119B 평면image" />

			<MenuBar contents={menuContents} />

			<div className={styles.textBox}>
			<div>리버뷰의 여유와 둔산 생활권의 편리함 위에</div>
			<div>해링턴 플레이스의 새로운 자부심이 찾아옵니다.</div>
				</div>
