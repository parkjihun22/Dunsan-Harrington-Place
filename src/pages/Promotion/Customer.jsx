...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/mpwrzjgb", {
        method: "POST",
  ...
  return (
    ...
    <>
        <Helmet>
          ...
          <title>둔산 해링턴 플레이스 - 관심고객등록</title>
          <meta
            name="description"
            content="둔산 해링턴 플레이스 관심고객 등록 시 모델하우스 방문예약, 분양 소식·청약 일정·위치 등 현장 정보를 가장 먼저 안내받으세요."
          />
          ...
          <meta property="og:title" content="둔산 해링턴 플레이스 - 관심고객등록" />
          <meta
            property="og:description"
            content="모델하우스 방문예약과 분양/청약 일정 알림, 위치·현장 정보까지. 둔산 해링턴 플레이스 관심고객 등록으로 빠르게 받아보세요."
          />
          ...
          <meta name="twitter:title" content="둔산 해링턴 플레이스 - 관심고객등록" />
          <meta
            name="twitter:description"
            content="관심고객 등록으로 모델하우스 예약·분양 소식·청약 일정·위치 정보를 우선 안내받으세요."
          />
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "둔산 해링턴 플레이스 - 관심고객등록",
              "url": "https://www.cssdesign.kr/Promotion/Customer",
              "description":
                "둔산 해링턴 플레이스 관심고객 등록: 모델하우스 방문예약, 분양 소식·청약 일정·위치 등 현장 정보 우선 안내.",
              "primaryImageOfPage": {
                "@type": "ImageObject",
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>둔산 해링턴 플레이스</h2>
