...
const ComplexGuide1 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<meta property="og:title" content="둔산 해링턴 플레이스 - 단지배치도" />
			<meta
			...
			<meta name="twitter:title" content="둔산 해링턴 플레이스 - 단지배치도" />
			<meta
			...
			<h1 className={styles.screenReaderOnly}>둔산 해링턴 플레이스 - 단지배치도</h1>
			<p className={styles.screenReaderOnly}>
			둔산 해링턴 플레이스의 전체 단지배치도를 제공합니다. 세대 배치, 조경, 커뮤니티 시설,
			주차 공간 등 생활 편의를 고려한 공간 설계를 시각적으로 확인할 수 있습니다.
			</p>

			<div className={styles.textBox}>
			<div>리버뷰의 여유와 함께</div>
			<div>생활을 품은 단지배치의 기준</div>
			</div>
